...
This is a task for the [Advanced Beginner Level of the Laravel Roadmap](https://github.com/ashokhirpara1/laravel-learning-path#advanced-beginner-level), with the goal to implement as many of its topics as possible.
